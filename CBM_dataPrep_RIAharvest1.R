defineModule(sim, list(
  ...
  outputObjects = bindrows(
    ...
    createsOutput(
      ...
      desc = "Ages of the stands from the inventory in 2020 with ages <=1 changes to 2 for the spinup"
    ),
    createsOutput(
      objectName = "realAges", objectClass = "numeric",
      desc = "Ages of the stands from the inventory in 2020 saved to replace the ages post spinup"
    ),
    createsOutput(
