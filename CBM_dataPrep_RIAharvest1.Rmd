...
df_params <- SpaDES.core::moduleParams("CBM_dataPrep_RIApresentDay", "..")
...
df_inputs <- SpaDES.core::moduleInputs("CBM_dataPrep_RIApresentDay", "..")
...
df_outputs <- SpaDES.core::moduleOutputs("CBM_dataPrep_RIApresentDay", "..")
